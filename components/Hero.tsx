  ...
  return (
    <section className="relative h-screen w-full overflow-hidden flex items-end md:items-center justify-start">
      ...
      <div className="relative z-10 px-6 md:px-12 pb-24 md:pb-0 max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-white/40 text-xs uppercase tracking-[0.4em] animate-pulse">Scroll to explore works</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-12 right-12 hidden md:block text-right">
        <span className="text-white/20 text-[8rem] font-serif font-bold italic leading-none pointer-events-none">S.C</span>
      </div>
    </section>
  );
};
